...
A robust, production-ready REST API backend for a restaurant booking platform. Built with **Node.js**, **Express**, **TypeScript**, and **MongoDB**, featuring real-time notifications, authentication, image uploads more.
